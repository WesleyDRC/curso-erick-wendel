...
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Indlc2xleTEyMyIsImlkIjoxLCJpYXQiOjE2NDE5MTM5NzB9.tO1jPOqA32ANkml9e58WBReMZsB_titiiy-JaroiRcI'
...
describe('Suite de testes na API Heroes', function (){
    ...
    it('remover DELETE - /heroes/:id - não deve remover com id inválido', async () => {
